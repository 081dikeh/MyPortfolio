...
export default function Contact() { 
    return (
        <section className="font-fira gap-8 mt-20 mb-20">
            <h2 className="text-3xl text-white flex items-center font-[500]"><span className="text-brand-700">#</span>Contacts<span className="ring-1 ring-brand-700 w-0 md:w-96 h-[0px] inline-block ml-6"></span></h2>
            <div className="flex flex-col md:flex-row justify-between gap-8 mt-8">
                ...
                <div className=" flex md:w-[50%] justify-center md:justify-end">
