...
// Show only first 4 projects on the home page
    ...
    <section className="font-fira mt-32 sm:mt-40 md:mt-52">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        {featured.map((project) => (
          <div key={project.id} className="ring-1 ring-brand-500 flex flex-col hover:ring-brand-700 transition-all duration-300 group">
            {/* Project image */}
